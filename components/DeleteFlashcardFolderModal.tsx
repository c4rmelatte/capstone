    ...
    <Modal transparent animationType="fade" visible={visible} onRequestClose={onCancel}>
      ...
      >
        ...
        >
          ...
          >
            <Feather name="alert-triangle" size={20} color="#555" style={{ marginRight: 10 }} />
            <Text style={{ color: "#555", flex: 1 }}>
              Warning! Once deleted, you will no longer retrieve these flashcards.
            </Text>
          </View>
          ...
          <View style={{ flexDirection: "row", justifyContent: "space-between", width: "100%" }}>
            ...
            >
              <Text style={{ color: "#E64A45", fontWeight: "bold" }}>Cancel</Text>
            </Pressable>
          </View>
        </View>
      </View>
