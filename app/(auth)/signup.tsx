...
const LoginScreen = () => {
  ...
  return (
    <ImageBackground source={Images.Loginbg} resizeMode="cover" className="flex-1 items-center">
      <View className="items-center mt-10">
        ...
        <View className="pb-5 items-center">
          <Text
            className="mt-44 text-[70px] font-black text-[#FFEF9A]"
            style={{
          ...
          <Text
            className="text-[#553A00] text-center text-[17px]"
            style={{
        ...
        <View className="h-8" />
        {/* Login Button */}
        <CustomButton title="Sign Up" onPress={() => router.replace("/(tabs)/home")} />
